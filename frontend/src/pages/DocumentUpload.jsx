...
export default function DocumentUpload() {
  ...
  const validateForm = () => {
    ...
    if (bridePreviouslyMarried) {
      ...
      else if (brideDivorceType === "civil" && !files.civilDivorceDoc)
        newErrors.civilDivorceDoc = true;
      else if (brideDivorceType === "islamic" && !files.islamicDivorceDoc)
        newErrors.islamicDivorceDoc = true;
      ...
      <div>
        ...
        {files[name] ? (
          ...
          >
            ...
            />
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center mb-3 text-slate-500 transition-colors"
              style={{
    ...
    <>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Please provide clear, legible copies of all required documents to
            proceed with your Nikah application.
          </p>
        </div>
      </div>
      ...
      >
        <div
          className="bg-amber-100 p-2 rounded-lg flex-shrink-0"
          style={{
        ...
        <div>
          <h4
            className="font-bold text-amber-900 text-lg mb-2"
            style={{
              color: "#78350f",
              fontWeight: 700,
              fontSize: "1.125rem",
          ...
          <ul
            className="list-disc pl-5 text-amber-800 text-sm leading-relaxed"
            style={{
              color: "#92400e",
              fontSize: "0.9rem",
              lineHeight: 1.6,
          ...
          >
            <li>
              Valid <strong>Passport</strong> or{" "}
              <strong>Driving Licence</strong> (Both parties)
            </li>
            <li>
              <strong>Witness IDs</strong> for two Muslim male witnesses
            </li>
            <li>
              Signed <strong>Dowry (Mahr) Declaration</strong>
            </li>

            <li>
              <strong>Divorce Documents</strong> (if applicable)
            </li>
            <li>
              <strong>Certificate of Conversion to Islam</strong> (if
              applicable)
            </li>
            <li>
              <strong>Statutory Declaration (Affidavit) for Ahle Kitab</strong>{" "}
              (if applicable)
            </li>
          </ul>
        </div>
      ...
      >
        ...
        <div className="space-y-4">
          <div
            className="flex items-center gap-2 mb-4 pb-2 border-b border-slate-200"
            style={{
              display: "flex",
              alignItems: "center",
              gap: "0.5rem",
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <h3
                className="text-md font-semibold text-slate-800 m-0"
                style={{
                  fontSize: "1rem",
                  fontWeight: 600,
                  color: "var(--slate-800)",
          ...
          <div
            ...
            style={{
              display: showConversion ? "block" : "none",
              padding: "1.5rem",
            }}
          >
            {/* Conversion To Islam */}
            <div>
              ...
              >
                ...
                />
                <label
                  htmlFor="conversionCheck"
                  className="font-semibold text-slate-800 select-none cursor-pointer"
                  style={{ fontWeight: 600, color: "var(--slate-800)" }}
                >
              ...
              {hasConversionCertificate && (
                <div
                  className="pl-0 md:pl-8 border-l-2 border-slate-100 ml-2 animate-in fade-in slide-in-from-top-2 duration-300"
                  style={{
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      {groomConverted && (
                        <div
                          className="pl-0 md:pl-8 ml-2 animate-in fade-in slide-in-from-top-2 duration-300"
                          style={{ paddingLeft: "2rem", marginLeft: "0.5rem" }}
                        >
                          <UploadCard
            ...
            <div>
              ...
              {brideAhleKitab && (
                <div
                  className="space-y-6 pl-0 md:pl-8 border-l-2 border-slate-100 ml-2 animate-in fade-in slide-in-from-top-2 duration-300"
                  style={{
                    borderLeft: "2px solid var(--slate-100)",
                    paddingLeft: "2rem",
                    marginLeft: "0.5rem",
                ...
                >
                  ...
                  >
                    <strong>Note:</strong> The Statutory Declaration (Affidavit)
                    must be signed by a solicitor or a Commissioner of Oaths.
                  </div>
                  <div
                    style={{
                      display: "grid",
            ...
            <div>
              ...
              {bridePreviouslyMarried && (
                <div
                  className="space-y-6 pl-0 md:pl-8 border-l-2 border-slate-100 ml-2"
                  style={{
                    borderLeft: "2px solid var(--slate-100)",
                    paddingLeft: "2rem",
                    marginLeft: "0.5rem",
      ...
      <div
        className="mt-10 flex justify-end pt-6 border-t border-slate-200"
        style={{
          marginTop: "2.5rem",
          display: "flex",
      ...
      >
        <button
          ...
          style={{
            opacity: isSubmitDisabled() || uploading ? 0.7 : 1,
            minWidth: "200px",
            display: "flex",
            alignItems: "center",
            gap: "0.75rem",
            boxShadow: "0 4px 6px -1px rgba(202, 108, 64, 0.2)",
          }}
        >
          {uploading ? (
            <>
