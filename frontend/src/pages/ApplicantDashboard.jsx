...
import {
  ...
  requestBankDetails as requestBankDetailsAPI,
  getFileUrl,
  getCertificate,
} from "../services/api";
...
export default function ApplicantDashboard() {
  ...
  const handleDownloadCertificate = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `marriage-certificate-${
        app.application_number || "certificate"
      }.pdf`;
  ...
  const areAllDocumentsUploaded = () => {
    ...
    const basicDocs =
      app.groom_id_path &&
      app.bride_id_path &&
      app.witness1_id_path &&
      app.witness2_id_path &&
      app.mahr_declaration_path;
    if (!basicDocs) return false;

    // Conditional: Previously Married
    if (app.bride_previously_married) {
      if (app.bride_divorce_type === "civil" && !app.civil_divorce_doc_path)
        return false;
      if (app.bride_divorce_type === "islamic" && !app.islamic_divorce_doc_path)
        return false;
      if (
        app.bride_divorce_type === "both" &&
        (!app.civil_divorce_doc_path || !app.islamic_divorce_doc_path)
      )
        return false;
    }
  ...
  return (
    <>
      {/* Hero Header */}
      <div
        className="applicant-dashboard-hero"
        style={{
      ...
      <div className="stats-grid">
        <StatCard
          ...
          variant="blue"
          subtitle={new Date(app.created_at).toLocaleDateString("en-GB", {
            day: "numeric",
            month: "short",
            year: "numeric",
          })}
        ...
        <StatCard
          ...
          subtitle={
            allDocumentsUploaded ? "All documents received" : "Action required"
          }
        />
        <StatCard
      ...
      {/* Main Content Grid */}
      <div
        className="applicant-content-grid"
        style={{
          display: "grid",
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Submit required ID proofs and documents
                      </p>
                    </div>
                  </div>
                  <button
            ...
            !app.payment_verified_at && (
              ...
              >
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  >
                    Thank you! Your payment receipt has been submitted
                    successfully. Our admin team will verify your payment
                    shortly and you'll be notified once approved.
                  </p>
                </div>
              </div>
            )}
          ...
          {app.status === "payment_verified" && !app.certificate_url && (
            ...
            >
              ...
              <div style={{ padding: "1.5rem" }}>
                ...
                >
                  <strong style={{ color: "#059669" }}>Excellent!</strong> Your
                  payment has been verified. Our admin team will now generate
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Next Step: Certificate Generation
                      </h4>
                      <p
                        style={{
                          margin: 0,
                  ...
                  >
                    ...
                    >
                      ...
                      <br />
                      Our admin team will generate your marriage certificate.
                      Once ready, you'll receive an email notification and can
            ...
            >
              ...
              <div style={{ padding: "1.5rem" }}>
                ...
                >
                  ...
                  >
                    💡 Please arrive on time with all required documents and
                    witnesses. Contact us if you need to reschedule.
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  >
                    ...
                    <strong
                      style={{ fontSize: "1.1rem", color: "var(--brand-600)" }}
                    >
                      £{app.deposit_amount}
                    </strong>{" "}
                    via bank transfer to proceed with your application.
                  </p>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <strong style={{ color: "var(--slate-600)" }}>
                          Account Name:
                        </strong>{" "}
                    ...
                    >
                      💡 After completing the transfer, upload your receipt
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              >
                ...
                {(() => {
                  ...
                  const isActive =
                    app.status === "admin_review" || app.status === "submitted";
                  return (
                    <div
                ...
                {(() => {
                  ...
                  const isActive =
                    app.approved_at != null && app.status === "admin_review";
                  return (
                    <div
                      style={{ marginBottom: "1.75rem", position: "relative" }}
                    >
                      <div
                        style={{
                          ...
                          height: "16px",
                          borderRadius: "50%",
                          background: docsUploaded
                            ? "#2563eb"
                            : isActive
                            ? "#f59e0b"
                            : "#cbd5e1",
                          border: "3px solid white",
                          boxShadow: docsUploaded
                            ? "0 0 0 3px #2563eb"
                            : isActive
                            ? "0 0 0 3px #f59e0b"
                            : "none",
                    ...
                    >
                      ...
                      >
                        {paymentDone
                          ? `Receipt uploaded`
                          : isActive
                          ? `Action required - Pay £${app.deposit_amount}`
                          : app.deposit_amount
                          ? `£${app.deposit_amount} required`
                          : "Not yet"}
                      </p>
                    </div>
                  );
                ...
                {(() => {
                  const isCompleted =
                    app.status === "completed" || app.certificate_url != null;
                  const isActive =
                    app.status === "payment_verified" ||
